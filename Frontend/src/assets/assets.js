...
export const doctors = [
  {
    ...
    experience: "4 Years",
    about:
      "Dr. Richard James is a renowned doctor specializing in general physician services.",
    fees: 50,
    address: {
  ...
  },
  {
    ...
    experience: "8 Years",
    about:
      "Dr. Maria Gomez is an experienced dermatologist treating skin disorders.",
    fees: 60,
    address: {
      line1: "25th Avenue, Downtown",
      line2: "Central Plaza",
      city: "New York",
    },
  },
  {
    ...
    fees: 120,
    address: {
      line1: "5th Street, North Block",
      line2: "Heart Care Center",
      city: "Chicago",
    },
  },
  {
    ...
    experience: "6 Years",
    about:
      "Dr. Sarah Khan specializes in children's healthcare and development.",
    fees: 80,
    address: {
      line1: "12th Street, Green Park",
      line2: "Children's Hospital",
      city: "Sydney",
    },
  },
  {
    ...
    experience: "15 Years",
    about: "Dr. John Lee is an expert in bone and joint surgeries.",
    fees: 150,
    address: {
      line1: "9th Lane, King's Road",
      line2: "Ortho Specialty Clinic",
      city: "Toronto",
    },
  },
  {
    ...
    experience: "7 Years",
    about:
      "Dr. Emily Johnson focuses on women's reproductive health and childbirth.",
    fees: 100,
    address: {
      line1: "14th Street, Madison Square",
      line2: "Women's Health Center",
      city: "Los Angeles",
    },
  },
  {
    ...
    fees: 140,
    address: {
      line1: "6th Boulevard, Willow Street",
      line2: "Neuro Care Institute",
      city: "San Francisco",
    },
  },
  {
    ...
    experience: "9 Years",
    about: "Dr. Laura Smith provides specialized eye care and surgeries.",
    fees: 110,
    address: {
      line1: "45th Street, Vision Tower",
      line2: "Eye Care Clinic",
      city: "Miami",
    },
  },
  {
    ...
    experience: "11 Years",
    about:
      "Dr. Robert Patel treats ear, nose, and throat conditions with great expertise.",
    fees: 90,
    address: {
      line1: "Green Hill Avenue",
      line2: "ENT Care Center",
      city: "Delhi",
    },
  },
  {
    ...
    experience: "13 Years",
    about:
      "Dr. Alice Moore helps patients with mental health issues and emotional well-being.",
    fees: 130,
    address: {
      line1: "21st Street, Pine Ridge",
      line2: "Mental Health Clinic",
      city: "Boston",
    },
  },
  {
    _id: "doc11",
    name: "Dr. Nitish James",
    image:
    "https://raw.githubusercontent.com/avinashdm/gs-images/main/prescripto/doc9.png",
    speciality: "General Physician",
    degree: "MBBS",
